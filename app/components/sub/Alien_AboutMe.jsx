...
Command: npx gltfjsx@6.2.16 public/models/Alien/Alien.gltf -o app/components/sub/Alien.jsx -r public 
...
export default function Alien_AboutMe(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF(
    "/models/Alien_AboutMe/Alien_AboutMe.gltf"
  );
...
useGLTF.preload("/models/Alien_AboutMe/Alien_AboutMEe.gltf");
