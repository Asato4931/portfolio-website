...
Command: npx gltfjsx@6.2.18 public/models/Shuttle/Shuttle.gltf -o app/components/sub/Shuttle.jsx 
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Shuttle.gltf')
