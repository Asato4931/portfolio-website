...
Command: npx gltfjsx@6.2.18 public/models/Alien_AboutMe/Alien_AboutMe.gltf -o app/components/sub/Alien_AboutMe.jsx 
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Alien_AboutMe.gltf')
...
useGLTF.preload('/Alien_AboutMe.gltf')
