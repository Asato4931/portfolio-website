...
Command: npx gltfjsx@6.2.18 public/models/Alien_Projects/Alien_Projects.gltf -o app/components/sub/Alien_Projects.jsx 
...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Alien_Projects.gltf')
...
useGLTF.preload('/Alien_Projects.gltf')
